...
void simulation_results(std::vector<float, aligned_allocator<float> >& in1, // Input Matrix 1
...
int main(int argc, char** argv) {
    ...
    simulation_results(source_in1_full, source_in2_full, source_sw_results_full, DATA_SIZE);
